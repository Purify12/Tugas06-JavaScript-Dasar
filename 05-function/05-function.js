...
console.log("salary = 4.500.000, taxCalc = " + taxCalc(4500000));
console.log("salary = 5.000.000, taxCalc = " + taxCalc(5000000));
console.log("salary = 20.000.000, taxCalc = " + taxCalc(20000000));
...
console.log("result = " + firstNonRepeatedChar("hello world"));
console.log("result = " + firstNonRepeatedChar("alloha"));
console.log("result = " +firstNonRepeatedChar("wooohoowh"));